...
```{r}
lm1 <- lm(GDP_Per_Capita ~ Absence_Corruption_Index, full_2021_data)
lm2 <- lm(GDP_Per_Capita ~ Absence_Corruption_Index, log_2021_data)
tibble("R Squared Non Transformed" = summary(lm1)$r.squared, "R Squared Log Transformed" = summary(lm2)$r.squared) |>
  reactable() |>
  add_title("Comparison of R Squared of Two Linear Models")
```
