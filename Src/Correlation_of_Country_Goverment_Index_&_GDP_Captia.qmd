...
```
With a average residual $ < |10^{-9}|$ this looks pretty promising, but to confirm our calculations and better visualize the distributions of residuals lets plot them on a histogram.  What we expect is a normal distribution of all residuals reminiscent of the fimilar bell curve.
